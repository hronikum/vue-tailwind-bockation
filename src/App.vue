...
<div id="app" class=" min-h-screen bg-gray-200 antialiased">
  <header class="bg-gray-900 text-gray-500">
    <div class="flex justify-between px-4 py-3 font-bold">
      <span class=" text-2xl">Workation</span>
      <div class="flex">
        <button class="px-2 text-gray-500 hover:text-white focus:outline-none focus:text-white">
          <svg class="h-6 w-6 fill-current " height="24px" id="Layer_1" style="enable-background:new 0 0 24 24;" version="1.1" viewBox="0 0 32 32" width="24px" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    ...
    <nav>
      ...
      <div class="px-5 py-5 ">
        ...
        <div class="mt-5">
          <a href="#" class="block text-grey-400 hover:text-white">Account settings</a>
          <a href="#" class="mt-3 block text-grey-400 hover:text-white">Support</a>
          <a href="#" class="mt-3 block text-grey-400 hover:text-white">Sign out</a>
        </div>
      </div>
    </nav>
  </header>
  <section class="flex justify-between bg-gray-800  px-4 py-3">
    <div class="relative">
      <div class="absolute inset-y-0 left-0 flex items-center pl-3">
        <svg class="h-6 w-6 fill-current text-gray-600" width="24" height="24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd">
      ...
      <input class="bg-gray-900 focus:outline-non focus:bg-white focus:text-gray-900 text-white rounded-lg px-10 pr-4 py-2" placeholder="Search by keywords">
    </div>
    <button class="inline-flex items-center bg-gray-700 hover:bg-gray-600 focus:outline-non focus:shadow-outline focus:bg-gray-600 rounded-lg shadow pl-4 pr-4">
      <svg class="h-6 w-6 fill-current text-gray-500" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
        <path d="M13 6h-13v-4h13v4zm0 4h-13v4h13v-4zm0 8h-13v4h13v-4zm3-8l4 5.075 4-5.075h-8z" /></svg>
      <span class="ml-1 text-white font-medium">Filters</span>
    </button>
  </section>
  <main class="px-4 py-6">
    <h3 class="text-gray-900 text-xl">Los Angeles</h3>
    <p class="text-gray-600">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Tenetur, asperiores?</p>
    <div class="mt-6">
      <div>
        <div>
          <img class="rounded-lg shadow-md h-64" src="https://images.unsplash.com/photo-1512917774080-9991f1c4c750?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80" alt="">
        </div>
        <div class="relative px-4 -mt-16">
          <div class=" bg-white rounded-lg shadow-lg px-4 py-4">
            ...
            <div class="mt-2 flex items-center text-sm text-gray-600 ">
              <svg class="h-4 w-4 fill-current text-teal-500" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
